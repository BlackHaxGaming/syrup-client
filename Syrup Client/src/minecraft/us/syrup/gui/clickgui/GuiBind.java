...
import us.syrup.utils.KeyUtils;
...
public class GuiBind extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		int currentBoundTextFontSize = Syrup.instance.getFontRenderer().getFontSize() - 3;
		int escapeTextFontSize = Syrup.instance.getFontRenderer().getFontSize() - 8;
	...
	protected void keyTyped(char typedChar, int keyCode) throws IOException {
		...
		ModuleManager moduleManager = Syrup.instance.getModuleManager();
